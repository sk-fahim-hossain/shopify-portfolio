...
import GDevBot from "@/components/Shared/GDevBot";
...
export const metadata = {
  title: "Fahim Hossain | SHOPIFY DEVELOPER",
  description:
  ...
  return (
    ...
    >
      ...
      <body className="bg-[#030303] text-white">
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window,document,'script','dataLayer','GTM-TKKD3DBR');
            `,
          }}
        />
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TKKD3DBR"
            height="0"
            width="0"
            style={{
              display: "none",
